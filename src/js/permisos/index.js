...
const CargarAplicaciones = async () => {
    const url = '/app_login/permisos/aplicaciones';
    const config = {
        method: 'GET'
    }
...
const GuardarPermiso = async (event) => {
    ...
    const url = '/app_login/permisos/guardar';
    const config = {
        method: 'POST',
        body
    }
...
const BuscarPermiso = async () =>{
    const url = '/app_login/permisos/buscar';
    const config = {
        method: 'GET'
    }
...
const ModificarPermiso = async (event) => {
    ...
    const url = '/app_login/permisos/modificar';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarPermiso = async (e) => {
    ...
    try {
        const respuesta = await fetch('/app_login/permisos/eliminar', {
            method: 'POST',
