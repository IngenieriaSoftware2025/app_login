...
const guardarUsuario = async e => {
  ...
  try {
    ...
    const url = "/app_login/usuarios/guardar"
    const config = {
      method: 'POST',
      body
    }
...
const BuscarUsuario = async () =>{
    const url = '/app_login/usuarios/buscar';
    const config = {
        method: 'GET'
    }
...
const ModificarUsuario = async (event) => {
    ...
    const url = '/app_login/usuarios/modificar';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarUsuario = async (e) => {
    ...
    try {
        const respuesta = await fetch('/app_login/usuarios/eliminar', {
            method: 'POST',
