...
const GuardarAplicacion = async (event) => {
    ...
    const url = '/app_login/aplicaciones/guardar';
    const config = {
        method: 'POST',
        body
    }
...
const BuscarAplicacion = async () =>{
    const url = '/app_login/aplicaciones/buscar';
    const config = {
        method: 'GET'
    }
...
const ModificarAplicacion = async (event) => {
    ...
    const url = '/app_login/aplicaciones/modificar';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarAplicacion = async (e) => {
    ...
    try {
        const respuesta = await fetch('/app_login/aplicaciones/eliminar', {
            method: 'POST',
